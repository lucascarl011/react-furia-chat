...
export default function App() {
  ...
  return (
    <div className="bg-black text-white h-screen flex flex-col items-center justify-between px-4 py-6 sm:px-6 md:px-8">
      <h1 className="text-2xl sm:text-3xl font-bold text-yellow-400 text-center">
        FURIA FanBot 🐆🔥 — Seu assistente oficial do time de CS:GO!
      </h1>

      <div
        ref={chatRef}
        className="flex-1 w-full max-w-xl overflow-y-auto my-4 p-4 bg-gray-900 rounded-lg shadow-inner sm:max-w-3xl"
      >
      ...
      <div className="w-full max-w-xl flex gap-2 sm:max-w-3xl">
        <input
